...
export class Code {
	...
	private buildImportTargetDiagnosticsConsistency(
		...
		const isConsistent = signalMatchesTotals && visibilityMatchesCounts && droppedMatchesDelta && coverageMatchesCounts && windowHierarchyMatchesCounts;
