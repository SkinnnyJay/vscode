---
name: code-quality
description: Audits TypeScript/React/Next code for quality, AI slop, architectural debt, and performance. Use when reviewing code quality, planning refactors, or before major changes.
---
