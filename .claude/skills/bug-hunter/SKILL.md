---
name: bug-hunter
description: Performs deep adversarial static analysis. Finds non-obvious bugs, security flaws, race conditions, and AI slop. Use when scanning files, folders, or repo for correctness, security, performance, or maintainability.
---
