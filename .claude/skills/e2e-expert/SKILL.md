...
Use the project's config for base URL and test data: check `package.json` scripts, `playwright.config.*`, and any env or test fixtures. Override base URL, test accounts, and DB usage per project; do not assume a fixed localhost or account set.
