...
selected_status_counts_partial_zero_raw_status_map_partition_scope_summary="$tmpdir/selected-status-counts-partial-zero-raw-status-map-partition-scope.json"
selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary="$tmpdir/selected-status-counts-partial-zero-raw-status-map-partition-scope-step.md"
selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_summary="$tmpdir/selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope.json"
selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary="$tmpdir/selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope-step.md"
...
selected_status_counts_partial_malformed_no_evidence_zero_scope_summary="$tmpdir/selected-status-counts-partial-malformed-no-evidence-zero-scope.json"
selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-no-evidence-zero-scope-step.md"
selected_status_counts_partial_malformed_no_evidence_string_zero_scope_summary="$tmpdir/selected-status-counts-partial-malformed-no-evidence-string-zero-scope.json"
selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-no-evidence-string-zero-scope-step.md"
selected_status_counts_partial_malformed_nonselected_evidence_scope_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-scope.json"
selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-scope-step.md"
selected_status_counts_partial_malformed_nonselected_evidence_string_scope_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-string-scope.json"
selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-string-scope-step.md"
selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-zero-scope.json"
selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-zero-scope-step.md"
selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope.json"
selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary="$tmpdir/selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope-step.md"
...
selected_non_success_status_precedence_skip_scope_summary="$tmpdir/selected-non-success-status-precedence-skip-scope.json"
selected_non_success_status_precedence_skip_scope_step_summary="$tmpdir/selected-non-success-status-precedence-skip-scope-step.md"
selected_non_success_status_precedence_not_run_scope_summary="$tmpdir/selected-non-success-status-precedence-not-run-scope.json"
selected_non_success_status_precedence_not_run_scope_step_summary="$tmpdir/selected-non-success-status-precedence-not-run-scope-step.md"
...
selected_executed_string_scalar_count_ignored_empty_list_scope_summary="$tmpdir/selected-executed-string-scalar-count-ignored-empty-list-scope.json"
selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary="$tmpdir/selected-executed-string-scalar-count-ignored-empty-list-scope-step.md"
selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope.json"
selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope-step.md"
selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_summary="$tmpdir/selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope.json"
...
selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-scalar-count-ignored-nonempty-list-scope-step.md"
selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope.json"
selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope-step.md"
selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope-step.md"
selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope-step.md"
selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope-step.md"
selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-step.md"
selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-step.md"
selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary="$tmpdir/selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope.json"
selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-step.md"
...
selected_executed_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope.json"
selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope-step.md"
selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-raw-status-counts-string-ignored-partial-status-map-scope.json"
selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-raw-status-counts-string-ignored-partial-status-map-scope-step.md"
selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope.json"
selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope-step.md"
selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope.json"
selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-step.md"
selected_executed_scalar_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-scalar-ignored-partial-status-map-scope.json"
selected_executed_scalar_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-scalar-ignored-partial-status-map-scope-step.md"
selected_executed_string_scalar_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-scalar-ignored-partial-status-map-scope.json"
selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-scalar-ignored-partial-status-map-scope-step.md"
selected_executed_string_zero_scalar_ignored_partial_status_map_scope_summary="$tmpdir/selected-executed-string-zero-scalar-ignored-partial-status-map-scope.json"
selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary="$tmpdir/selected-executed-string-zero-scalar-ignored-partial-status-map-scope-step.md"
...
unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_summary="$tmpdir/unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list.json"
unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary="$tmpdir/unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list-step.md"
unscoped_executed_string_scalar_count_overrides_empty_list_summary="$tmpdir/unscoped-executed-string-scalar-count-overrides-empty-list.json"
unscoped_executed_string_scalar_count_overrides_empty_list_step_summary="$tmpdir/unscoped-executed-string-scalar-count-overrides-empty-list-step.md"
unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_summary="$tmpdir/unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list.json"
unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary="$tmpdir/unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list-step.md"
unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_summary="$tmpdir/unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list.json"
unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary="$tmpdir/unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list-step.md"
unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_summary="$tmpdir/unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list.json"
...
unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary="$tmpdir/unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list.json"
unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary="$tmpdir/unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-step.md"
unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary="$tmpdir/unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list.json"
unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary="$tmpdir/unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-step.md"
...
unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary="$tmpdir/unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list.json"
unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary="$tmpdir/unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-step.md"
unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary="$tmpdir/unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list.json"
unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary="$tmpdir/unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-step.md"
...
unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary="$tmpdir/unscoped-executed-string-zero-scalar-overrides-explicit-list-step.md"
unscoped_executed_scalar_count_overrides_partial_status_map_summary="$tmpdir/unscoped-executed-scalar-count-overrides-partial-status-map.json"
...
unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_summary="$tmpdir/unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map.json"
unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary="$tmpdir/unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map-step.md"
...
unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_summary="$tmpdir/unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map.json"
unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary="$tmpdir/unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map-step.md"
...
node - "$expected_schema_version" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-zero-raw-status-map-partition-scope-contract',
	selectedGateIds: ['lint', 'typecheck', 'build'],
	passedGateCount: 9,
	failedGateCount: 8,
	skippedGateCount: 7,
	...
	executedGateCount: 5,
	statusCounts: { pass: 0, fail: '0', skip: 0, 'not-run': 0 },
	gateStatusById: { lint: 'pass', typecheck: 'unknown' },
	failedGateIds: ['typecheck'],
	notRunGateIds: ['build'],
	gates: [],
};
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_zero_raw_status_map_partition_scope_summary" "Verify Gates Selected Status Counts Partial Zero Raw Status-Map Partition Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope-contract',
	selectedGateIds: ['lint', 'typecheck', 'build'],
	passedGateCount: 0,
	failedGateCount: 0,
	skippedGateCount: 0,
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_summary" "Verify Gates Selected Status Counts Partial Zero Scalar Raw Status-Map Partition Scope Contract Test"
...
node - "$expected_schema_version" "$selected_status_counts_partial_malformed_no_evidence_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-no-evidence-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: 9,
	passedGateCount: 8,
	failedGateCount: 7,
...
node - "$expected_schema_version" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-no-evidence-zero-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: 9,
	passedGateCount: 8,
	failedGateCount: 7,
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_no_evidence_zero_scope_summary" "Verify Gates Selected Status Counts Partial Malformed No Evidence Zero Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-no-evidence-string-zero-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: ' 9 ',
	passedGateCount: ' 8 ',
	failedGateCount: ' 7 ',
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_summary" "Verify Gates Selected Status Counts Partial Malformed No Evidence String Zero Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-nonselected-evidence-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: 9,
	passedGateCount: 8,
	failedGateCount: 7,
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_nonselected_evidence_scope_summary" "Verify Gates Selected Status Counts Partial Malformed Nonselected Evidence Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-nonselected-evidence-string-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: ' 9 ',
	passedGateCount: ' 8 ',
	failedGateCount: ' 7 ',
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_summary" "Verify Gates Selected Status Counts Partial Malformed Nonselected Evidence String Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-nonselected-evidence-zero-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: 9,
	passedGateCount: 8,
	failedGateCount: 7,
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_summary" "Verify Gates Selected Status Counts Partial Malformed Nonselected Evidence Zero Scope Contract Test"

node - "$expected_schema_version" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateCount: ' 9 ',
	passedGateCount: ' 8 ',
	failedGateCount: ' 7 ',
...
GITHUB_STEP_SUMMARY="$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_summary" "Verify Gates Selected Status Counts Partial Malformed Nonselected Evidence String Zero Scope Contract Test"
...
node - "$expected_schema_version" "$selected_non_success_status_precedence_skip_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-non-success-status-precedence-skip-scope-contract',
	selectedGateIds: ['lint'],
...
GITHUB_STEP_SUMMARY="$selected_non_success_status_precedence_skip_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_non_success_status_precedence_skip_scope_summary" "Verify Gates Selected Non-Success Status Precedence Skip Scope Contract Test"

node - "$expected_schema_version" "$selected_non_success_status_precedence_not_run_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-non-success-status-precedence-not-run-scope-contract',
	selectedGateIds: ['lint'],
...
GITHUB_STEP_SUMMARY="$selected_non_success_status_precedence_not_run_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_non_success_status_precedence_not_run_scope_summary" "Verify Gates Selected Non-Success Status Precedence Not-Run Scope Contract Test"
...
node - "$expected_schema_version" "$selected_executed_string_scalar_count_ignored_empty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-count-ignored-empty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass', typecheck: 'fail' },
	executedGateIds: [],
	executedGateCount: ' 5 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_count_ignored_empty_list_scope_summary" "Verify Gates Selected Executed String Scalar Count Ignored Empty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: [],
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_summary" "Verify Gates Selected Executed Scalar And Raw Status Counts Ignored Empty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: [],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_summary" "Verify Gates Selected Executed String Scalar And Raw Status Counts Ignored Empty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: [],
...
node - "$expected_schema_version" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-count-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Scalar Count Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Zero Scalar Count Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed Scalar And Raw Status Counts Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Scalar And Raw Status Counts Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Zero Scalar And Raw Status Counts Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed Scalar Partial Malformed Raw Status Counts Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Scalar Partial Malformed Raw Status Counts Ignored Nonempty List Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_summary" "Verify Gates Selected Executed String Zero Scalar Partial Malformed Raw Status Counts Ignored Nonempty List Scope Contract Test"
...
node - "$expected_schema_version" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	statusCounts: { pass: 0, fail: 0, skip: 5, 'not-run': 0 },
	gates: [],
};
fs.writeFileSync(summaryPath, JSON.stringify(payload, null, 2));
NODE

GITHUB_STEP_SUMMARY="$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Raw Status Counts Nonzero Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-raw-status-counts-string-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	statusCounts: { pass: '2', fail: '3', skip: '0', 'not-run': '0' },
...
GITHUB_STEP_SUMMARY="$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Raw Status Counts String Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	statusCounts: { pass: '4', fail: 'bad', skip: '0', 'not-run': null },
	gates: [],
};
fs.writeFileSync(summaryPath, JSON.stringify(payload, null, 2));
NODE

GITHUB_STEP_SUMMARY="$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Raw Status Counts Partial Malformed Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: 5,
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Scalar And Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 5 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Scalar And Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 0 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Zero Scalar And Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: 5,
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Scalar Partial Malformed Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 5 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Scalar Partial Malformed Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 0 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Zero Scalar Partial Malformed Raw Status Counts Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_scalar_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-scalar-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: 5,
...
GITHUB_STEP_SUMMARY="$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_scalar_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed Scalar Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_scalar_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-scalar-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 5 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_scalar_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Scalar Ignored Partial Status-Map Scope Contract Test"

node - "$expected_schema_version" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'selected-executed-string-zero-scalar-ignored-partial-status-map-scope-contract',
	selectedGateIds: ['lint', 'typecheck'],
	gateStatusById: { lint: 'pass' },
	failedGateIds: ['typecheck'],
	executedGateCount: ' 0 ',
...
GITHUB_STEP_SUMMARY="$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" ./scripts/publish-verify-gates-summary.sh "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_summary" "Verify Gates Selected Executed String Zero Scalar Ignored Partial Status-Map Scope Contract Test"
...
node - "$expected_schema_version" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-status-counts-partial-malformed-no-evidence-string-scalar-contract',
	passedGateCount: ' 8 ',
	failedGateCount: ' 7 ',
	skippedGateCount: ' 6 ',
	notRunGateCount: ' 5 ',
...
node - "$expected_schema_version" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list-contract',
	gateStatusById: { lint: 'pass', build: 'fail' },
	executedGateIds: [],
	executedGateCount: 5,
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_summary" "Verify Gates Unscoped Executed Scalar And Raw Status Counts Override Empty List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_scalar_count_overrides_empty_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-scalar-count-overrides-empty-list-contract',
	gateStatusById: { lint: 'pass', build: 'fail' },
	executedGateIds: [],
	executedGateCount: ' 5 ',
	gates: [],
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_scalar_count_overrides_empty_list_summary" "Verify Gates Unscoped Executed String Scalar Count Overrides Empty List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list-contract',
	gateStatusById: { lint: 'pass', build: 'fail' },
	executedGateIds: [],
	executedGateCount: ' 5 ',
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_summary" "Verify Gates Unscoped Executed String Scalar And Raw Status Counts Override Empty List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list-contract',
	gateStatusById: { lint: 'pass', build: 'fail' },
	executedGateIds: [],
	executedGateCount: 0,
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_summary" "Verify Gates Unscoped Executed Zero Scalar And Raw Status Counts Override Empty List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list-contract',
	gateStatusById: { lint: 'pass', build: 'fail' },
	executedGateIds: [],
	executedGateCount: ' 0 ',
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_summary" "Verify Gates Unscoped Executed String Zero Scalar And Raw Status Counts Override Empty List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_zero_scalar_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-zero-scalar-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: 0,
...
GITHUB_STEP_SUMMARY="$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_zero_scalar_overrides_explicit_list_summary" "Verify Gates Unscoped Executed Zero Scalar Overrides Explicit List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-zero-scalar-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: ' 0 ',
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_zero_scalar_overrides_explicit_list_summary" "Verify Gates Unscoped Executed String Zero Scalar Overrides Explicit List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: 5,
...
node - "$expected_schema_version" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: 5,
...
GITHUB_STEP_SUMMARY="$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" "Verify Gates Unscoped Executed Scalar Partial Malformed Raw Status Counts Override Explicit List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: 0,
...
GITHUB_STEP_SUMMARY="$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" "Verify Gates Unscoped Executed Zero Scalar Partial Malformed Raw Status Counts Override Explicit List Contract Test"
...
node - "$expected_schema_version" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: ' 5 ',
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" "Verify Gates Unscoped Executed String Scalar Partial Malformed Raw Status Counts Override Explicit List Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: ' 0 ',
...
GITHUB_STEP_SUMMARY="$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_summary" "Verify Gates Unscoped Executed String Zero Scalar Partial Malformed Raw Status Counts Override Explicit List Contract Test"
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list-contract',
	passedGateIds: ['lint'],
	failedGateIds: ['typecheck'],
	executedGateIds: ['lint', 'typecheck'],
	executedGateCount: 0,
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-scalar-count-overrides-partial-status-map-contract',
...
GITHUB_STEP_SUMMARY="$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_scalar_count_overrides_partial_status_map_summary" "Verify Gates Unscoped Executed Scalar Count Overrides Partial Status-Map Contract Test"

node - "$expected_schema_version" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map-contract',
	gateStatusById: { typecheck: 'pass' },
	failedGateIds: ['lint'],
	executedGateCount: 5,
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_summary" "Verify Gates Unscoped Executed Scalar And Raw Status Counts Override Partial Status-Map Contract Test"

node - "$expected_schema_version" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-scalar-count-overrides-partial-status-map-contract',
	gateStatusById: { typecheck: 'pass' },
	failedGateIds: ['lint'],
	executedGateCount: ' 5 ',
	retriedGateIds: ['lint'],
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-string-zero-scalar-count-overrides-partial-status-map-contract',
	gateStatusById: { typecheck: 'pass' },
	failedGateIds: ['lint'],
	executedGateCount: ' 0 ',
	retriedGateIds: ['lint'],
...
node - "$expected_schema_version" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_summary" <<'NODE'
const fs = require('node:fs');
const [schemaVersionRaw, summaryPath] = process.argv.slice(2);
const schemaVersion = Number.parseInt(schemaVersionRaw, 10);
if (!Number.isInteger(schemaVersion) || schemaVersion <= 0) {
...
const payload = {
	schemaVersion,
	runId: 'unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map-contract',
	gateStatusById: { typecheck: 'pass' },
	failedGateIds: ['lint'],
	executedGateCount: 0,
	statusCounts: { pass: 2, fail: 3, skip: 0, 'not-run': 0 },
...
GITHUB_STEP_SUMMARY="$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" ./scripts/publish-verify-gates-summary.sh "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_summary" "Verify Gates Unscoped Executed Zero Scalar And Raw Status Counts Override Partial Status-Map Contract Test"
...
if ! grep -Fq "**Selected gates:** lint, typecheck, build" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Gate count:** 3" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to preserve selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Not-run gates:** 1" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to merge selected status-map and partition fallback evidence while ignoring conflicting selected scalar/raw count inputs." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":1}' "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to keep selected status-count metadata aligned with merged status-map/partition evidence despite explicit zero raw statusCounts." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to keep malformed selected status-map values filtered while sparse selected status-map metadata remains visible." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 2" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to derive selected executed/pass-rate metadata from merged status-map/partition evidence under explicit zero raw statusCounts conflicts." >&2
	exit 1
fi
if grep -Fq '**Status counts:** {"pass":0,' "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-raw-status-map-partition-scope summary to prevent explicit zero raw statusCounts from overriding selected merged status evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_zero_raw_status_map_partition_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-zero-raw-status-map-partition-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck, build" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Gate count:** 3" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to preserve selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Not-run gates:** 1" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to ignore explicit zero selected scalar/raw bundles and derive counters from merged selected status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":1}' "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to keep status counts aligned with merged selected status-map/partition evidence under explicit zero scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to keep malformed selected status-map values filtered while sparse selected status-map metadata remains visible." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 2" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to derive selected executed/pass-rate metadata from merged selected evidence under explicit zero scalar/raw conflicts." >&2
	exit 1
fi
if grep -Fq '**Status counts:** {"pass":0,' "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary to prevent explicit zero selected scalar/raw bundles from overriding merged selected status evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_zero_scalar_raw_status_map_partition_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-zero-scalar-raw-status-map-partition-scope summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to ignore selected-scope scalar counters and partial malformed raw status-count counters when no selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to keep status counts aligned with selected no-evidence fallback counters under partial malformed raw statusCounts input." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to keep executed metadata empty under selected no-evidence partial malformed payloads." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to render executed-rate metrics as n/a under selected no-evidence partial malformed payloads." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary" || grep -Fq "**Executed gates:** 4" "$selected_status_counts_partial_malformed_no_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-scope summary to suppress partial malformed raw/scalar branch leakage under selected no-evidence fallback." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to ignore selected-scope scalar counters and partial malformed raw status-count counters when no selected execution evidence exists, even with explicit zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to keep status counts aligned with selected no-evidence fallback counters under partial malformed raw statusCounts input." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to keep executed metadata empty under selected no-evidence partial malformed payloads with explicit zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to render executed-rate metrics as n/a under selected no-evidence partial malformed payloads with explicit zero executed denominator." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary" || grep -Fq "**Executed gates:** 4" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-zero-scope summary to suppress partial malformed raw/scalar branch leakage under selected no-evidence fallback." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_no_evidence_zero_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-no-evidence-zero-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to ignore normalized numeric-string scalar counters and partial malformed raw status-count counters when no selected execution evidence exists, even with normalized zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to keep status counts aligned with selected no-evidence fallback counters under partial malformed raw statusCounts input." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to keep executed metadata empty under selected no-evidence partial malformed numeric-string payloads with normalized zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to render executed-rate metrics as n/a under selected no-evidence partial malformed numeric-string payloads with normalized zero executed denominator." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary" || grep -Fq "**Executed gates:** 4" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary to suppress partial malformed raw/normalized numeric-string scalar branch leakage under selected no-evidence fallback." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_no_evidence_string_zero_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-no-evidence-string-zero-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-scope summary to scope out non-selected list/map execution evidence and conflicting scalar/raw counters when selected execution evidence is absent." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-scope summary to keep status counts aligned with selected no-evidence fallback counters when only non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-scope summary to keep executed metadata empty when only non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
...
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_nonselected_evidence_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-nonselected-evidence-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-scope summary to scope out normalized non-selected list/map execution evidence and conflicting normalized scalar/raw counters when selected execution evidence is absent." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-scope summary to keep status counts aligned with selected no-evidence fallback counters when only normalized non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-scope summary to keep executed metadata empty when only normalized non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
...
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_nonselected_evidence_string_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-nonselected-evidence-string-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-zero-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-zero-scope summary to scope out non-selected list/map execution evidence and conflicting scalar/raw counters when selected execution evidence is absent, including explicit zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-zero-scope summary to keep status counts aligned with selected no-evidence fallback counters when only non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-zero-scope summary to keep executed metadata empty when only non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
...
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_nonselected_evidence_zero_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-nonselected-evidence-zero-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Gate count:** 2" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope summary to preserve explicit selected scope metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Failed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope summary to scope out normalized non-selected list/map execution evidence and conflicting normalized scalar/raw counters when selected execution evidence is absent, including normalized zero executed denominator." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":0,"fail":0,"skip":0,"not-run":0}' "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope summary to keep status counts aligned with selected no-evidence fallback counters when only normalized non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
	echo "Expected selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope summary to keep executed metadata empty when only normalized non-selected execution evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
...
if grep -q "\*\*Schema warning:\*\*" "$selected_status_counts_partial_malformed_nonselected_evidence_string_zero_scope_step_summary"; then
	echo "Did not expect schema warning for selected-status-counts-partial-malformed-nonselected-evidence-string-zero-scope summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint" "$selected_non_success_status_precedence_skip_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-skip-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_non_success_status_precedence_skip_scope_step_summary" || ! grep -Fq "**Skipped gates:** 1" "$selected_non_success_status_precedence_skip_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-skip-scope summary to surface conflicting pass/skip aggregate metadata for diagnostic visibility." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_non_success_status_precedence_skip_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_non_success_status_precedence_skip_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_non_success_status_precedence_skip_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-skip-scope summary to derive non-executed metadata from selected status-map skip evidence despite conflicting selected pass partition and executedGateCount scalar inputs." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 1" "$selected_non_success_status_precedence_skip_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_non_success_status_precedence_skip_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 100%" "$selected_non_success_status_precedence_skip_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-skip-scope summary to suppress conflicting selected executed/count partition evidence when selected status-map skip evidence is authoritative." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$selected_non_success_status_precedence_skip_scope_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$selected_non_success_status_precedence_skip_scope_step_summary"; then
...
if ! grep -Fq "**Selected gates:** lint" "$selected_non_success_status_precedence_not_run_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-not-run-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_non_success_status_precedence_not_run_scope_step_summary" || ! grep -Fq "**Not-run gates:** 1" "$selected_non_success_status_precedence_not_run_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-not-run-scope summary to surface conflicting pass/not-run aggregate metadata for diagnostic visibility." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_non_success_status_precedence_not_run_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_non_success_status_precedence_not_run_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_non_success_status_precedence_not_run_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-not-run-scope summary to derive non-executed metadata from selected status-map not-run evidence despite conflicting selected pass partition and executedGateCount scalar inputs." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 1" "$selected_non_success_status_precedence_not_run_scope_step_summary" || grep -Fq "**Executed gates:** 4" "$selected_non_success_status_precedence_not_run_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 100%" "$selected_non_success_status_precedence_not_run_scope_step_summary"; then
	echo "Expected selected-non-success-status-precedence-not-run-scope summary to suppress conflicting selected executed/count partition evidence when selected status-map not-run evidence is authoritative." >&2
	exit 1
fi
...
if grep -q "\*\*Schema warning:\*\*" "$selected_non_success_status_precedence_not_run_scope_step_summary"; then
	echo "Did not expect schema warning for selected-non-success-status-precedence-not-run-scope summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-empty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Executed gates list:** none" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-empty-list-scope summary to preserve explicit empty selected executed-list metadata despite conflicting numeric-string executedGateCount scalar." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-empty-list-scope summary to render executed-rate metrics as n/a under explicit empty selected executed-list evidence despite conflicting numeric-string scalar executed count." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-empty-list-scope summary to suppress numeric-string scalar executed-count override under explicit selected empty executed-list evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_count_ignored_empty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-count-ignored-empty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 0" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected partition and explicit empty executed-list counters despite conflicting scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit empty executed-list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** none" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to keep executed-rate metrics as n/a under selected explicit empty executed-list precedence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected attention metadata under scalar+raw conflict suppression." >&2
	exit 1
fi
if grep -Fq "**Passed gates:** 2" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Failed gates:** 3" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress scalar/raw override branches under selected explicit empty executed-list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-and-raw-status-counts-ignored-empty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 0" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected partition and explicit empty executed-list counters despite conflicting numeric-string scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit empty executed-list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** none" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to keep executed-rate metrics as n/a under selected explicit empty executed-list precedence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected attention metadata under numeric-string scalar+raw conflict suppression." >&2
	exit 1
fi
if grep -Fq "**Passed gates:** 2" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Failed gates:** 3" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress numeric-string scalar/raw override branches under selected explicit empty executed-list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-and-raw-status-counts-ignored-empty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected partition and explicit empty executed-list counters despite conflicting numeric-string zero scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit empty executed-list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** none" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to keep executed-rate metrics as n/a under selected explicit empty executed-list precedence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to preserve selected attention metadata under numeric-string zero scalar+raw conflict suppression." >&2
	exit 1
fi
if grep -Fq "**Passed gates:** 2" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Failed gates:** 3" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_empty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-empty-list-scope summary to suppress numeric-string zero scalar/raw override branches under selected explicit empty executed-list precedence." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-nonempty-list-scope summary to ignore conflicting selected numeric-string executedGateCount scalar and preserve explicit selected executed list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-nonempty-list-scope summary to derive executed-rate metrics from explicit selected executed/retried list evidence despite conflicting numeric-string scalar executed count." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-count-ignored-nonempty-list-scope summary to suppress numeric-string scalar executed-count override under selected scope when explicit executed list evidence exists." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-count-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope summary to ignore conflicting selected numeric-string zero executedGateCount scalar and preserve explicit selected executed list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope summary to derive executed-rate metrics from explicit selected executed/retried list evidence despite conflicting numeric-string zero scalar executed count." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope summary to suppress numeric-string zero scalar executed-count override under selected scope when explicit executed list evidence exists." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_count_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-count-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress scalar/raw executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting numeric-string scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress numeric-string scalar/raw executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting numeric-string zero scalar and raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting unscoped raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary to suppress numeric-string zero scalar executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-and-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting partial malformed raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress scalar/partial malformed raw executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting numeric-string scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting partial malformed raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress numeric-string scalar/partial malformed raw executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve explicit selected partition/executed list counters despite conflicting numeric-string zero scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":1,"skip":0,"not-run":0}' "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress conflicting partial malformed raw statusCounts projections under selected explicit list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to keep executed-rate derivation on selected explicit executed/retried list evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to preserve selected attention list ordering from selected non-success and retried evidence." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary to suppress numeric-string zero scalar/partial malformed raw executed-count/rate overrides under selected explicit list precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_nonempty_list_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-nonempty-list-scope summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to suppress conflicting raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting non-zero raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting non-zero raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to suppress conflicting non-zero raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_raw_status_counts_nonzero_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-raw-status-counts-nonzero-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting numeric-string raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting numeric-string raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to suppress conflicting numeric-string raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_raw_status_counts_string_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-raw-status-counts-string-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting partially malformed raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting partially malformed raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 4" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 100%" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to suppress conflicting partially malformed raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_raw_status_counts_partial_malformed_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-raw-status-counts-partial-malformed-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting scalar and raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting scalar and raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to suppress conflicting scalar and raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting numeric-string scalar and raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting numeric-string scalar and raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to suppress conflicting numeric-string scalar and raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting numeric-string zero scalar and raw statusCounts payload." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting numeric-string zero scalar and raw statusCounts payload." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to suppress conflicting numeric-string zero scalar and raw statusCounts executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_and_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-and-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed counters despite conflicting scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed-rate derivation under mixed scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected non-success/attention metadata under mixed scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to suppress scalar/partial malformed raw overrides under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed counters despite conflicting numeric-string scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed-rate derivation under mixed numeric-string scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected non-success/attention metadata under mixed numeric-string scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to suppress numeric-string scalar/partial malformed raw overrides under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed counters despite conflicting numeric-string zero scalar and partial malformed raw statusCounts payloads." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected sparse status-map/partition executed-rate derivation under mixed numeric-string zero scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve selected non-success/attention metadata under mixed numeric-string zero scalar/raw conflicts." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -Fq "**Failed gates:** 3" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary to suppress numeric-string zero scalar/partial malformed raw overrides under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_partial_malformed_raw_status_counts_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-partial-malformed-raw-status-counts-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting executedGateCount scalar." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting executedGateCount scalar." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to suppress executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-scalar-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-scalar-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting numeric-string executedGateCount scalar." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting numeric-string executedGateCount scalar." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to suppress numeric-string executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-scalar-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-scalar-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
if ! grep -Fq "**Selected gates:** lint, typecheck" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to preserve selected-gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Failed gates:** 1" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Executed gates:** 2" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to derive executed counts from merged selected status-map and sparse partition fallback data despite conflicting numeric-string zero executedGateCount scalar." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates list:** lint, typecheck" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Pass rate (executed gates):** 50%" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to derive executed list/pass-rate from merged selected status-map and sparse partition fallback data despite conflicting numeric-string zero executedGateCount scalar." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to suppress numeric-string zero executed-count override under selected sparse status-map/partition fallback evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** typecheck" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary" || ! grep -Fq "**Attention gates list:** typecheck" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to align selected non-success metadata with merged status-map/partition evidence." >&2
	exit 1
fi
if ! grep -Fq '**Gate status map:** {"lint":"pass"}' "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Expected selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary to preserve explicit partial selected status-map metadata." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$selected_executed_string_zero_scalar_ignored_partial_status_map_scope_step_summary"; then
	echo "Did not expect schema warning for selected-executed-string-zero-scalar-ignored-partial-status-map-scope summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Gate count:** 0" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to keep gate count at zero when no gate evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 8" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || ! grep -Fq "**Failed gates:** 7" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || ! grep -Fq "**Skipped gates:** 6" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || ! grep -Fq "**Not-run gates:** 5" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to preserve valid normalized numeric-string scalar partition counters." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":8,"fail":3,"skip":6,"not-run":5}' "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to merge valid raw fail status-count with normalized numeric-string scalar fallback for malformed raw siblings." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 4" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to preserve normalized numeric-string executedGateCount scalar while no executed-list evidence exists." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 100%" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 0%" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to derive rates from normalized numeric-string scalar/merged status-count no-evidence metadata." >&2
	exit 1
fi
if grep -Fq "**Status counts:** {\"pass\":8,\"fail\":7,\"skip\":6,\"not-run\":5}" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary" || grep -Fq "**Executed gates:** 0" "$unscoped_status_counts_partial_malformed_no_evidence_string_scalar_step_summary"; then
	echo "Expected unscoped-status-counts-partial-malformed-no-evidence-string-scalar summary to suppress malformed-raw fail fallback omission and zero-executed fallback branches." >&2
	exit 1
fi
...
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to preserve gate count from sparse status-map IDs." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to keep explicit executedGateCount scalar authoritative over explicit empty executed-list metadata." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 0%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to derive executed-rate metrics from scalar executed-count denominator plus raw statusCounts pass counter." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** build" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to preserve non-success-derived attention metadata under combined scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary to suppress explicit empty executed-list fallback when scalar executed count is authoritative." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-scalar-and-raw-status-counts-overrides-empty-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to preserve gate count from sparse status-map IDs." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to normalize explicit numeric-string executedGateCount scalar over explicit empty executed list metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary" || ! grep -Fq "**Failed gates:** 1" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to preserve sparse pass/fail counters while normalized explicit executed scalar override is applied." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 0%" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to derive rate metrics from normalized explicit executedGateCount override and sparse pass/retry evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** build" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to preserve non-success-derived attention metadata under normalized explicit executed count override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-empty-list summary to suppress explicit empty executed-list override when normalized numeric-string executedGateCount scalar is authoritative." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_scalar_count_overrides_empty_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-scalar-count-overrides-empty-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to preserve gate count from sparse status-map IDs." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to keep normalized numeric-string executedGateCount scalar authoritative over explicit empty executed-list metadata." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 0%" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to derive executed-rate metrics from normalized numeric-string scalar denominator plus raw statusCounts pass counter." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** build" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to preserve non-success-derived attention metadata under combined numeric-string scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary to suppress explicit empty executed-list fallback when normalized numeric-string scalar executed count is authoritative." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-scalar-and-raw-status-counts-overrides-empty-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve gate count from sparse status-map IDs." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to keep explicit executedGateCount zero scalar authoritative over explicit empty executed-list metadata." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to render executed-rate metrics as n/a from explicit zero scalar denominator despite raw status-count evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** build" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve non-success-derived attention metadata under combined zero-scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary to suppress non-zero executed-count/rate derivation under explicit zero scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-zero-scalar-and-raw-status-counts-overrides-empty-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve gate count from sparse status-map IDs." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Executed gates list:** none" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to keep normalized numeric-string zero executedGateCount scalar authoritative over explicit empty executed-list metadata." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to render executed-rate metrics as n/a from normalized numeric-string zero scalar denominator despite raw status-count evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** build" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to preserve non-success-derived attention metadata under combined numeric-string zero-scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary to suppress non-zero executed-count/rate derivation under normalized numeric-string zero scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_zero_scalar_and_raw_status_counts_overrides_empty_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-zero-scalar-and-raw-status-counts-overrides-empty-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to keep explicit executedGateCount scalar authoritative while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to derive executed-rate metrics from scalar executed-count denominator plus raw statusCounts/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under combined scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary to suppress implicit executed-count/rate fallback under combined scalar+raw precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-scalar-and-raw-status-counts-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to keep raw statusCounts pass/fail counters authoritative." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve explicit raw statusCounts metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to keep explicit executedGateCount zero scalar authoritative while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to render executed-rate metrics as n/a from explicit zero scalar denominator despite raw status-count evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under combined zero-scalar+raw precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-explicit-list summary to suppress non-zero executed-count/rate derivation under explicit zero scalar precedence." >&2
	exit 1
fi
...
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep valid raw fail status-count fields while malformed raw siblings fall back per field." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to merge partial raw statusCounts with list-derived fallback values per status key." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep executedGateCount scalar authoritative while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to derive executed-rate metrics from scalar denominator plus mixed-source pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under partial malformed raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to suppress implicit executed fallback under scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep valid raw fail status-count fields while malformed raw siblings fall back per field." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to merge partial raw statusCounts with list-derived fallback values per status key." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep explicit zero scalar denominator while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to render executed-rate metrics as n/a from explicit zero scalar denominator under mixed-source pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under partial malformed raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to suppress non-zero scalar executed/rate branches under explicit zero scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep valid raw fail status-count fields while malformed raw siblings fall back per field." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to merge partial raw statusCounts with list-derived fallback values per status key." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep normalized numeric-string executedGateCount scalar authoritative while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to derive executed-rate metrics from normalized numeric-string scalar denominator plus mixed-source pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under partial malformed raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to suppress implicit executed fallback under normalized numeric-string scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Skipped gates:** 0" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Not-run gates:** 0" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep valid raw fail status-count fields while malformed raw siblings fall back per field." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":1,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to merge partial raw statusCounts with list-derived fallback values per status key." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to keep normalized numeric-string zero scalar denominator while preserving explicit executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to render executed-rate metrics as n/a from normalized numeric-string zero scalar denominator under mixed-source pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under partial malformed raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary to suppress non-zero scalar executed/rate branches under normalized numeric-string zero scalar precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_zero_scalar_partial_malformed_raw_status_counts_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-zero-scalar-partial-malformed-raw-status-counts-overrides-explicit-list summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to keep explicit executed list labels while scalar executed count zero remains authoritative." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to render executed-rate metrics as n/a when scalar executedGateCount is zero despite explicit executed lists." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 1" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to preserve partition counters while scalar executed-count zero controls rates." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under scalar executed-count zero override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-overrides-explicit-list summary to ignore executed list length for executed-count/rate calculations when scalar executedGateCount is explicitly zero." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-zero-scalar-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Executed gates list:** lint, typecheck" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to keep explicit executed list labels while normalized numeric-string scalar executed count zero remains authoritative." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to render executed-rate metrics as n/a when normalized numeric-string executedGateCount is zero despite explicit executed lists." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 1" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary" || ! grep -Fq "**Failed gates:** 1" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to preserve partition counters while normalized numeric-string scalar executed-count zero controls rates." >&2
	exit 1
fi
if ! grep -Fq "**Attention gates list:** lint, typecheck" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to preserve non-success and retried-derived attention metadata under normalized numeric-string scalar executed-count zero override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-overrides-explicit-list summary to ignore executed list length for executed-count/rate calculations when normalized numeric-string executedGateCount is zero." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_zero_scalar_overrides_explicit_list_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-zero-scalar-overrides-explicit-list summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-count-overrides-partial-status-map summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Executed gates list:** typecheck, lint" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-count-overrides-partial-status-map summary to preserve explicit executedGateCount scalar over implicit sparse status-map/partition executed fallback count while retaining executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-count-overrides-partial-status-map summary to derive executed-rate metrics from explicit executedGateCount scalar and sparse pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-count-overrides-partial-status-map summary to preserve sparse non-success and retried attention metadata under explicit executed scalar override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Retry rate (executed gates):** 50%" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-count-overrides-partial-status-map summary to suppress implicit sparse executed-count/rate derivation when explicit executedGateCount scalar is provided." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-scalar-count-overrides-partial-status-map summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-partial-status-map summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Executed gates list:** typecheck, lint" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-partial-status-map summary to normalize explicit numeric-string executedGateCount scalar over implicit sparse executed fallback while preserving executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 20%" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-partial-status-map summary to derive executed-rate metrics from normalized numeric-string executedGateCount scalar and sparse pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-partial-status-map summary to preserve sparse non-success and retried attention metadata under normalized numeric-string executed scalar override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Retry rate (executed gates):** 50%" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-scalar-count-overrides-partial-status-map summary to suppress implicit sparse executed-count/rate derivation when explicit numeric-string executedGateCount scalar is provided." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_string_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-string-scalar-count-overrides-partial-status-map summary." >&2
	exit 1
fi
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve raw statusCounts pass/fail precedence over sparse partition fallback counts." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve raw statusCounts metadata while executedGateCount scalar remains authoritative." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 5" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Executed gates list:** typecheck, lint" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve explicit executedGateCount scalar over implicit sparse executed fallback while retaining executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Retry rate (executed gates):** 20%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to derive executed-rate metrics from executedGateCount scalar plus raw statusCounts/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve sparse non-success and retried attention metadata under combined scalar and raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary to suppress implicit sparse executed-count/rate derivation under combined scalar and raw status-count precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-scalar-and-raw-status-counts-overrides-partial-status-map summary." >&2
	exit 1
fi
...
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Executed gates list:** typecheck, lint" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-count-overrides-partial-status-map summary to normalize explicit numeric-string zero executedGateCount scalar over implicit sparse executed fallback while preserving executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-count-overrides-partial-status-map summary to render executed-rate metrics as n/a from normalized numeric-string zero executedGateCount scalar despite sparse pass/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-count-overrides-partial-status-map summary to preserve sparse non-success and retried attention metadata under normalized numeric-string zero executed scalar override." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary" || grep -Fq "**Retry rate (executed gates):** 50%" "$unscoped_executed_string_zero_scalar_count_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-string-zero-scalar-count-overrides-partial-status-map summary to suppress implicit sparse executed-count/rate derivation when explicit numeric-string zero executedGateCount scalar is provided." >&2
	exit 1
fi
...
if ! grep -Fq "**Gate count:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve sparse gate metadata." >&2
	exit 1
fi
if ! grep -Fq "**Passed gates:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Failed gates:** 3" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve raw statusCounts pass/fail precedence over sparse partition fallback counts." >&2
	exit 1
fi
if ! grep -Fq '**Status counts:** {"pass":2,"fail":3,"skip":0,"not-run":0}' "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve raw statusCounts metadata while executedGateCount zero scalar remains authoritative." >&2
	exit 1
fi
if ! grep -Fq "**Executed gates:** 0" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Executed gates list:** typecheck, lint" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve explicit executedGateCount zero scalar over implicit sparse executed fallback while retaining executed list labels." >&2
	exit 1
fi
if ! grep -Fq "**Pass rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Retry rate (executed gates):** n/a" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to render executed-rate metrics as n/a from explicit executedGateCount zero scalar despite raw statusCounts/retried evidence." >&2
	exit 1
fi
if ! grep -Fq "**Non-success gates list:** lint" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || ! grep -Fq "**Attention gates list:** lint" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to preserve sparse non-success and retried attention metadata under combined zero scalar and raw status-count precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 5" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 40%" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to suppress non-zero executed-count/rate derivation under explicit zero scalar precedence." >&2
	exit 1
fi
if grep -Fq "**Executed gates:** 2" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || grep -Fq "**Pass rate (executed gates):** 50%" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary" || grep -Fq "**Retry rate (executed gates):** 50%" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Expected unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary to suppress implicit sparse executed-count/rate derivation under combined zero scalar and raw status-count precedence." >&2
	exit 1
fi
if grep -q "\*\*Schema warning:\*\*" "$unscoped_executed_zero_scalar_and_raw_status_counts_overrides_partial_status_map_step_summary"; then
	echo "Did not expect schema warning for unscoped-executed-zero-scalar-and-raw-status-counts-overrides-partial-status-map summary." >&2
	exit 1
fi
